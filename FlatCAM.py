# ########################################################## ##
# Original project credits belong to the respective authors   #
# ########################################################## ##
...
import sys
import os
import re  ## Necesario para el filtro de warning QAccessibleTable::child

# --- Filtro de stderr Antimensaje: warning QAccessibleTable::child ---
class FilteredStderr:
    def __init__(self, original):
        self.original = original
        self.pattern = re.compile(r"QAccessibleTable::child.*Invalid index at: \d+ 0")
...
os.environ["QT_LOGGING_RULES"] = "qt.accessibility.*=false;qt.accessibility.core=false"
