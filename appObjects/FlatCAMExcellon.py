...
class ExcellonObject(FlatCAMObj, Excellon):
    ...
    def plot(self, visible=None, kind=None):
        ...
        # Aqui se mejoro: 
        # Ahora iter(self.solid_geometry) sobre un MultiPolygon genera el ShapelyDeprecationWarning. Con .geoms queda listo para Shapely 2.x.
        if self.solid_geometry is None:
            self.solid_geometry = []
        elif hasattr(self.solid_geometry, "geoms"):
