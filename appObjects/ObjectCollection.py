...
class TreeItem(KeySensitiveListView):
    ...
    def remove_child(self, item):
        ...
        try:
            ...
            log.debug("TreeItem.remove_child().clear() --> %s" % str(e))

        try:
            child.obj.delete()
        except Exception as e:
            log.debug("TreeItem.remove_child().delete() --> %s" % str(e))
    ...
    def remove_children(self):
        for child in self.child_items:
            try:
                ...
                log.debug("TreeItem.remove_children().clear() --> %s" % str(e))

            try:
                child.obj.delete()
            except Exception as e:
                log.debug("TreeItem.remove_children().delete() --> %s" % str(e))
            del child.obj
            del child
...
class ObjectCollection(QtCore.QAbstractItemModel):
    ...
    def delete_by_name(self, name, select_project=True):
        ...
        if obj is None:
            log.debug("ObjectCollection.delete_by_name() --> Object not found: %s" % str(name))
            return
    ...
    def set_active(self, name):
        ...
        try:
            ...
            if obj is None:
                log.debug("ObjectCollection.set_active() --> Object not found: %s" % str(name))
                return
    ...
    def set_inactive(self, name):
        ...
        if obj is None:
            log.debug("ObjectCollection.set_inactive() --> Object not found: %s" % str(name))
            return
