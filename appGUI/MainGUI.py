...
class MainGUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, app):
        ...
        self.setWindowTitle('FlatCAM %s - Shapely 2.x Friendly Edition - %s' %
            (self.app.version_name, platform.architecture()[0])
        )
    ...
    def set_ui_title(self, name):
        ...
        :return: None
        """              
        title = 'FlatCAM %s - Shapely 2.x Friendly Edition - %s - [%s]    %s' % (
            self.app.version, platform.architecture()[0], self.app.engine, name)
